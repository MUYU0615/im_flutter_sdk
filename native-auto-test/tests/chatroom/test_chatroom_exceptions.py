...
def test_chatroom_fetch_room_info_nonexistent(topology_primary_or_device_a, assert_api):
    """
...
@pytest.mark.clients("sender")
@pytest.mark.roles_mode("ordered")
def test_chatroom_destroy_room_nonexistent(topology_primary_or_device_a, assert_api):
    """
    ...
    room_id = _nonexistent_room_id()
    resp = topology_primary_or_device_a.call("ChatRoomManager", Cmd.destroyChatRoom.value, info={"roomId": room_id})
    assert_api.assert_error(resp, code=700, description="do not find this group")
...
@pytest.mark.roles_mode("ordered")
def test_chatroom_join_room_nonexistent_current_behavior(topology_primary_or_device_a, assert_api):
    """
    ...
    room_id = _nonexistent_room_id()
    resp = topology_primary_or_device_a.call("ChatRoomManager", Cmd.joinChatRoom.value, info={"roomId": room_id})
...
@pytest.mark.clients("receiver")
@pytest.mark.roles_mode("ordered")
def test_chatroom_join_room_empty_id(topology_primary_or_device_a, assert_api):
    """
    ...
    resp = topology_primary_or_device_a.call("ChatRoomManager", Cmd.joinChatRoom.value, info={"roomId": ""})
...
@pytest.mark.clients("receiver")
@pytest.mark.roles_mode("ordered")
def test_chatroom_leave_room_nonexistent(topology_primary_or_device_a, assert_api):
    """
    ...
    resp = client.call("ChatRoomManager", Cmd.leaveChatRoom.value, info={"roomId": room_id})
...
@pytest.mark.clients("receiver")
@pytest.mark.roles_mode("ordered")
def test_chatroom_leave_room_empty_id(topology_primary_or_device_a, assert_api):
    """
    ...
    client = topology_primary_or_device_a
    resp = client.call("ChatRoomManager", Cmd.leaveChatRoom.value, info={"roomId": ""})
    assert_api.assert_response_matches(
        resp,
        expected={
            "manager": "ChatRoomManager",
...
@pytest.mark.clients("sender")
@pytest.mark.roles_mode("ordered")
def test_chatroom_fetch_room_info_empty_id(topology_primary_or_device_a, assert_api):
    """
    ...
    resp = topology_primary_or_device_a.call("ChatRoomManager", Cmd.fetchChatRoomInfoFromServer.value, info={"roomId": ""})
    assert_api.assert_error(resp, code=700, description="Chat room ID is invalid")
...
@pytest.mark.clients("sender")
@pytest.mark.roles_mode("ordered")
def test_chatroom_fetch_members_nonexistent_room(topology_primary_or_device_a, assert_api):
    """
...
@pytest.mark.clients("sender")
@pytest.mark.roles_mode("ordered")
def test_chatroom_fetch_members_empty_room_id(topology_primary_or_device_a, assert_api):
    """
...
@pytest.mark.clients("sender")
@pytest.mark.roles_mode("ordered")
def test_chatroom_destroy_room_empty_id(topology_primary_or_device_a, assert_api):
    """
    ...
    resp = topology_primary_or_device_a.call("ChatRoomManager", Cmd.destroyChatRoom.value, info={"roomId": ""})
    assert_api.assert_error(resp, code=700, description="Chat room ID is invalid")
...
@pytest.mark.clients("sender")
@pytest.mark.roles_mode("ordered")
def test_chatroom_fetch_public_chat_rooms_invalid_paging(topology_primary_or_device_a, assert_api, page_num, page_size):
    """
