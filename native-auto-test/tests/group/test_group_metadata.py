...
def test_group_update_subject(topology, assert_api):
    """
    ...
    try:
        ...
        resp_local = primary.call("GroupManager", Cmd.getGroupWithId.value, info={"groupId": group_id})
        assert_group_snapshot(
            assert_api,
            resp_local,
...
@pytest.mark.e2e_flow("server_state")
@pytest.mark.topology_ready
def test_group_update_description(topology, assert_api):
    """
