...
def test_group_is_member_in_white_list_and_mute_list_success(topology_primary_or_device_a, assert_api, user_a):
    """
...
@pytest.mark.topology_ready
def test_group_is_member_in_white_list_and_mute_list_nonexistent_group(topology_primary_or_device_a, assert_api):
    """
    ...
    for cmd in (Cmd.isMemberInWhiteListFromServer.value, Cmd.isMemberInGroupMuteList.value):
        resp = client.call("GroupManager", cmd, info={"groupId": group_id})
