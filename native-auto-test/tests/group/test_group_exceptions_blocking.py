...
def test_group_block_nonexistent_group(topology_primary_or_device_a, assert_api):
    """
    ...
    resp = topology_primary_or_device_a.call("GroupManager", Cmd.blockGroup.value, info={"groupId": _NONEXISTENT_GROUP_ID})
...
@pytest.mark.clients("sender")
@pytest.mark.roles_mode("ordered")
def test_group_unblock_nonexistent_group(topology_primary_or_device_a, assert_api):
    """
    ...
    resp = topology_primary_or_device_a.call("GroupManager", Cmd.unblockGroup.value, info={"groupId": _NONEXISTENT_GROUP_ID})
    assert_api.assert_error(resp, code=600, description="do not find this group")
...
@pytest.mark.topology_ready
def test_group_block_idempotent(topology_primary_or_device_a, assert_api, user_a):
    """
    ...
    try:
        ...
        resp1 = client.call("GroupManager", Cmd.blockGroup.value, info={"groupId": group_id})
        ...
        resp2 = client.call("GroupManager", Cmd.blockGroup.value, info={"groupId": group_id})
        assert_api.assert_response_matches(
            resp2,
            expected={
                "manager": "GroupManager",
        ...
        if group_id:
            ...
            try:
                client.call("GroupManager", Cmd.unblockGroup.value, info={"groupId": group_id})
            except Exception:
                pass
...
@pytest.mark.e2e_flow("state_change")
@pytest.mark.topology_ready
def test_group_unblock_idempotent(topology_primary_or_device_a, assert_api, user_a):
    """
    ...
    try:
        ...
        resp1 = client.call("GroupManager", Cmd.unblockGroup.value, info={"groupId": group_id})
        assert_api.assert_response_matches(
            resp1,
            expected={
                "manager": "GroupManager",
        ...
        resp2 = client.call("GroupManager", Cmd.unblockGroup.value, info={"groupId": group_id})
        assert_api.assert_response_matches(
            resp2,
            expected={
                "manager": "GroupManager",
