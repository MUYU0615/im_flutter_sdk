---
id: generated/integration/message-send
title: websdk2 Integration - 发送消息
description: 来自 SDK 集成文档 docs/integration/message_send.md，用于回答 发送消息 相关接入问题。
---
...
- **接收方**：通过 `onMessage` 事件接收消息，详见 [接收消息](./message-receive.md)。
