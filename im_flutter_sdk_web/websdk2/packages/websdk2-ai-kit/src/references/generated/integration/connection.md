---
id: generated/integration/connection
title: websdk2 Integration - 连接状态管理与自动重连
description: 来自 SDK 集成文档 docs/integration/connection.md，用于回答 连接状态管理与自动重连 相关接入问题。
---
