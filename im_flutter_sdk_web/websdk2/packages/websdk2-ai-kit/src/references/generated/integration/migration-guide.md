---
id: generated/integration/migration-guide
title: websdk2 Integration - 旧 SDK 迁移指南
description: 来自 SDK 集成文档 docs/integration/migration-guide.md，用于回答 旧 SDK 迁移指南 相关接入问题。
---
...
| `WebIM.message.create({ type: 'read' })` | 使用 `chatManager.sendMessageReadAck()` |
