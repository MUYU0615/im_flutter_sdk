---
id: generated/integration/message-retrieve
title: websdk2 Integration - 获取历史消息
description: 来自 SDK 集成文档 docs/integration/message_retrieve.md，用于回答 获取历史消息 相关接入问题。
---
