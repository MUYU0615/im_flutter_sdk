---
id: generated/integration/initialization
title: websdk2 Integration - SDK 初始化
description: 来自 SDK 集成文档 docs/integration/initialization.md，用于回答 SDK 初始化 相关接入问题。
---
...
| `enableAutoSyncContacts` | boolean | 否 | 是否在登录后自动同步联系人快照。 |
...
详见 [连接状态管理](./connection.md) 和 [接收消息](./message-receive.md)。
