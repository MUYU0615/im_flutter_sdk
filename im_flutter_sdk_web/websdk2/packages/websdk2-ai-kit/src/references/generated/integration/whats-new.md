---
id: generated/integration/whats-new
title: websdk2 Integration - 新 SDK 增强与变化
description: 来自 SDK 集成文档 docs/integration/whats-new.md，用于回答 新 SDK 增强与变化 相关接入问题。
---
...
```typescript
// 配置
ChatClient.init({ appKey: '...', enableAutoSyncContacts: true });
