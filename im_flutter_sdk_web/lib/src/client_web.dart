...
class ClientWeb extends Client {
  ...
  Future<dynamic> callNativeMethod(String method, [dynamic params]) async {
    ...
    switch (method) {
      ...
      case 'dumpRealSdkGroupManagerMethods':
        return {method: _realSdk?.dumpGroupManagerMethods() ?? <String>[]};
      case 'dumpRealSdkChatThreadManagerMethods':
        return {method: _realSdk?.dumpChatThreadManagerMethods() ?? <String>[]};
