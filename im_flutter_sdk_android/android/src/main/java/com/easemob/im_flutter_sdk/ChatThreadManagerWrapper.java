...
public class ChatThreadManagerWrapper extends Wrapper implements MethodChannel.MethodCallHandler {
    ...
    public void onMethodCall(MethodCall call, MethodChannel.Result result) {
        ...
        try {
            if (MethodKey.fetchChatThreadDetail.equals(call.method)) {
                fetchChatThreadDetail(param, call.method, result);
            } else if (MethodKey.fetchJoinedChatThreads.equals(call.method)) {
                fetchJoinedChatThreads(param, call.method, result);
            } else if (MethodKey.fetchChatThreadsWithParentId.equals(call.method)) {
                fetchChatThreadsWithParentId(param, call.method, result);
            } else if (MethodKey.fetchJoinedChatThreadsWithParentId.equals(call.method)) {
                fetchJoinedChatThreadsWithParentId(param, call.method, result);
            } else if (MethodKey.fetchChatThreadMember.equals(call.method)) {
                fetchChatThreadMember(param, call.method, result);
            } else if (MethodKey.fetchLastMessageWithChatThreads.equals(call.method)) {
                fetchLastMessageWithChatThreads(param, call.method, result);
            } else if (MethodKey.removeMemberFromChatThread.equals(call.method)) {
                removeMemberFromChatThread(param, call.method, result);
            } else if (MethodKey.updateChatThreadSubject.equals(call.method)) {
                updateChatThreadSubject(param, call.method, result);
            } else if (MethodKey.createChatThread.equals(call.method)) {
                createChatThread(param, call.method, result);
            } else if (MethodKey.joinChatThread.equals(call.method)) {
                joinChatThread(param, call.method, result);
            } else if (MethodKey.leaveChatThread.equals(call.method)) {
                leaveChatThread(param, call.method, result);
            } else if (MethodKey.destroyChatThread.equals(call.method)) {
