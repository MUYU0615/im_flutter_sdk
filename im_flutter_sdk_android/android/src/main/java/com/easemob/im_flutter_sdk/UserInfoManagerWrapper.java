...
public class UserInfoManagerWrapper extends Wrapper implements MethodCallHandler {
    ...
    public void onMethodCall(MethodCall call, Result result) {
        ...
        try {
            if (MethodKey.updateOwnUserInfo.equals(call.method)) {
                updateOwnUserInfo(param, call.method, result);
            } else if (MethodKey.updateOwnUserInfoWithType.equals(call.method)) {
                updateOwnUserInfoWithType(param, call.method, result);
            } else if (MethodKey.fetchUserInfoById.equals(call.method)) {
